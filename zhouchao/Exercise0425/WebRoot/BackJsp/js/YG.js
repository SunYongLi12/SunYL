...
layui.use('table', function(){*/
	...
	var tableIns = table.render({
		elem: '#test'
			,url:'http://localhost:8080/Exercise0425/Servlet?action=seleYG'
	...
	,title: '用户数据表'
		,cols: [[
			...
			{field: 'js', title: '角色',  align:'center'},
			{field: 'bm', title: '部门', minWidth:150, align:'center'},
			{field: 'zc', title: '职称', align:'center'}
			]]
	,page: true
	});
